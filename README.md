...
[![Version](https://img.shields.io/badge/version-5.4.3-blue.svg)](https://github.com/UnDadFeated/ChronoArchiver/releases)
...
Release **5.4.3** — installers and AUR `pkgver` are aligned on this version.

### GitHub (Windows / macOS installers)

Download from [**Releases**](https://github.com/UnDadFeated/ChronoArchiver/releases) (**tag `v5.4.3`**):

| Platform | Asset |
|----------|--------|
| Windows x64 | `ChronoArchiver-Setup-5.4.3-win64.exe` |
| macOS | `ChronoArchiver-Setup-5.4.3-mac64.zip` |
...
Package **[chronoarchiver](https://aur.archlinux.org/packages/chronoarchiver)** at **5.4.3**:
