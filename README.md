...
[![Version](https://img.shields.io/badge/version-4.7.3-blue.svg)](https://github.com/UnDadFeated/ChronoArchiver/releases)
...
Release **4.7.3** — installers and AUR `pkgver` are aligned on this version.

### GitHub (Windows / macOS installers)

Download from [**Releases**](https://github.com/UnDadFeated/ChronoArchiver/releases) (**tag `v4.7.3`**):

| Platform | Asset |
|----------|--------|
| Windows x64 | `ChronoArchiver-Setup-4.7.3-win64.exe` |
| macOS | `ChronoArchiver-Setup-4.7.3-mac64.zip` |
...
Package **[chronoarchiver](https://aur.archlinux.org/packages/chronoarchiver)** at **4.7.3**:
