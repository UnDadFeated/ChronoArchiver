...
[![Version](https://img.shields.io/badge/version-3.5.1-blue.svg)](https://github.com/UnDadFeated/ChronoArchiver/releases)
...
| Platform | File |
|----------|------|
| **Windows x64** | `ChronoArchiver-3.5.1-win64.exe` |
| **macOS** | `ChronoArchiver-3.5.1-mac64.dmg` |
